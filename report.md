...
김준영 : 새로운 팀 프로젝트를 하면서 새로 배운 CFormView에 대해 배울 수 있었고
도구상자에서 Spin Control 을 사용해서 숫자가 올라가면 굵기도 굵어지는 코드를 배우고
수업 시간에 배우지 못한 하이퍼링크 컨트롤과 버튼을 누르면 고양이 사진이 뜨는 컨트롤을 따로 공부해서 추가해 보았습니다.
